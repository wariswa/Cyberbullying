...
export const App = () => {
  ...
  const content = [
    ...
    "*Trigger Warning*",
    "เว็บไซต์นี้มีคำถามเกี่ยวกับเหตุการณ์หรือประสบการณ์ในอดีตของตัวคุณซึ่งอาจมีผลกระทบต่อจิตใจคุณ ไม่มากก็น้อย",
    "หากคำถามของเราทำให้คุณรู้สึกไม่สบายใจหรืออึดอัด สามารถออกจากเว็บไซต์เราได้ทันที",
    "เว็บไซต์นี้ ไม่มีการเก็บข้อมูลจากผู้ใช้งาน เพียงแต่ต้องการเป็นส่วนหนึ่งในการส่งเสริมการใช้สื่อสังคมออนไลน์อย่างมีสติ", 
    "ไม่สายไปที่จะหยุด...",
    "Cyberbullying",
    ...
    //   handleCount={setCount}></YesNo>, //if yes go to b, if no go to g
     //go to c
    <InputBox allowClick={allowClick} heading={"เธอรู้สึกอย่างไร เมื่อได้พิมพ์คำเหล่านั้นออกไป?"} messagenumber={0}></InputBox>,
    ...
    <YesNo text={"เธอรู้จักคำว่า Cyberbullying ไหม?"} //orange
      ...
      customyes={"รู้จัก"}
      customno={"ไม่รู้จัก"}
      yes={count+2} //mango เปลี่ยนคำ
      no={count+1} //watermelon เปลี่ยนคำ
      handleCount={setCount}></YesNo>,
    ...
    "สิ่งนี้เปรียบเสมือนอาวุธที่คอยทิ่มแทงใจคนที่ตกเป็นเป้าหมายของสังคม ตัวอย่างเช่น การรุมด่าทอ การใช้คำพูดที่สร้าง Hate Speech (ทำร้ายด้วยวาจา) ซึ่งการกระทำเหล่านี้ผู้กระทำอาจจะไม่ได้คิด",
    "แต่ผู้ที่ถูกกระทำอาจจะนำไปคิดจนวิตกกังวล กระทบต่อการใช้ชีวิตประจำวัน การกระทำกลั่นแกล้งบนโลกออนไลน์จนบางครั้งก็อาจเป็นการกระทำที่เลยเถิดไปถึงขั้นผิดต่อกฎหมาย และจริยธรรม",
    ...
    "สื่อบนโลกออนไลน์ส่วนใหญ่จะมีฟังก์ชันให้กดรีพอร์ตหรือบล็อกบัญชีผู้ใช้นั้นๆ สามารถกดรีพอร์ตหรือบล็อกผู้ใช้ที่มาด่าทอ ปองร้ายเราได้ เพื่อความสบายใจของตัวเราเอง",
    ...
    "การตกเป็นเหยื่อของการ Cyberbullying มีผลกระทบหลายๆด้าน ทั้งจิตใจและสุขภาพทางอารมณ์ การคุยกับคนที่เราเองไว้ใจ จะช่วยบรรเทาผ่อนคลายความทุกข์ได้",
    ...
    "เธอคงเหนื่อยมากใช่ไหม ที่ต้องตกเป็นเหยื่อของการโดน Cyberbullying แต่เธอรู้ตัวรึเปล่า ว่าตัวเธอเองนั้นก็เก่งมากๆเหมือนกัน ที่ผ่านมาได้ขนาดนี้ ที่ยังคอยประคองตัวเองให้เติบโตมาได้อย่างสมบูรณ์แบบขนาดนี้ ได้โปรดจงมีความสุขกับสิ่งเล็กๆน้อยๆ ที่เกิดขึ้นในแต่ล่ะวัน อย่าเครียดอย่าให้ความสำคัญกับสิ่งที่ตัวเธอเองนั้นควบคุมไม่ได้ จงเติบโตและระลึกอยู่เสมอว่า ตัวเองมีคุณค่าและงดงามมากแค่ไหน",
    "และหากเธอเคยบูลลี่ใคร ทั้งตั้งใจและไมได้ตั้งใจ",
    "เราก็หวังว่าความคิดและทัศนคติของเธอจะเติบโตไปในทางที่ดี ไม่ปองร้ายใคร และมีความเข้าใจผู้อื่นมากกว่าเดิม",
    ...
    <YesNo text={"วันนี้เธอได้ความรู้เกี่ยวกับ Cyberbullying ไหม?"}
      ...
      no={count+1}
      handleCount={setCount}></YesNo>,
    localStorage.getItem("วันนี้")=="firstbutton"?"เราดีใจที่เราได้ให้ความรู้เล็กๆน้อยๆกับเธอนะ":"เราเสียใจที่ไม่สามารถให้ความรู้เธอได้เท่าที่ควรนะ",
    "เราต้องไปแล้วล่ะ",
